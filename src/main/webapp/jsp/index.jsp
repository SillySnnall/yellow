    ...
    <div class="container-fluid">
        ...
        <%--<div id="navbar" class="navbar-collapse collapse ">--%>
            ...
            <%--<form class="navbar-form navbar-right" >--%>
                <%--<input type="text" class="form-control" placeholder="Search..撒旦撒旦撒旦撒旦撒旦撒旦撒旦撒旦撒旦撒旦撒旦撒旦撒." >--%>
            <%--</form>--%>
        <%--</div>--%>
    </div>
</nav>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <input type="text" class="form-control" placeholder="请输入接口名" >
            <ul class="nav nav-sidebar ul_li">
...
<script>window.jQuery || document.write('<script src="../jQuery/jquery-3.3.1.min.js"><\/script>')</script>
